...
(function () {
    ...
    window.UEDITOR_CONFIG = {
		...
		,imagePath:window.WEB_ROOT_URL                                    //图片修正地址，同imagePath
		...
		,imageManagerPath:window.WEB_ROOT_URL                                    //图片修正地址，同imagePath
        ...
        , toolbars: [["source","undo","redo","bold","italic","underline","strikethrough","superscript","subscript","link","unlink","justifyleft","justifycenter","justifyright","justifyjustify","forecolor","fontsize","preview","insertimage","blockquote","insertcode","fullscreen"]]
...
//        }
        ...
        ,initialStyle:'p{line-height:1em;font-size:14px;font-family:Microsoft Yahei,微软雅黑,华文细黑,宋体,Arial;color:#4f4f4f;}'//编辑器层级的基数,可以用来改变字体等
